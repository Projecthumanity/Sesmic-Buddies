// Central translations object extracted from LanguageContext to keep fast-refresh working
export const translations = {
  ...
  fr: {
    ...
    apiKeyInfo: "Cette clé expirera toutes les 24 heures",
    ...
    contribute4: "Améliorer le design UI/UX",
  ...
  es: {
    ...
    contribute1: "Reportar errores y sugerir funciones",
    contribute2: "Mejorar la documentación y las traducciones",
    contribute3: "Agregar nuevas fuentes de datos y funciones",
